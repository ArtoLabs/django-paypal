...
class PayPalStandardBase(Model):
    ...
    cart_list_ids = models.CharField(max_length=512, blank=True, null=True)
    cart_list_qtys = models.CharField(max_length=512, blank=True, null=True)
    cart_list_shipping_costs = models.CharField(max_length=512, blank=True, null=True)
